let pokemonRepository = (function () {
  ...
  function showModal(pokemon) {
    ...
    /**
     * pokemon.types is an array of  objects
     * example:
     * "types": [
        {
            "slot": 1,
     ...
     * We use Array.map to go in each element of the array and generate a new element
     * in the exemple pokemon.types.map(item => item.type.name) we get each type object, go into the type and get the name
     * it will result in a new array of string, which we could join in a single string using Array.join()
     */
